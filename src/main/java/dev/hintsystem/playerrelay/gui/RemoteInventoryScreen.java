...
public class RemoteInventoryScreen extends Screen {
    ...
    private final PlayerInfoPayload player;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, TEXTURE, x, y, 0.0F, 0.0F, backgroundWidth, 17, 256, 256);
        context.drawTexture(RenderPipelines.GUI_TEXTURED, TEXTURE, x, y + 17, 0.0F, 139.0F, backgroundWidth, 83, 256, 256); //126.0F
