...
public class PlayerRelayCommands {
    ...
    public static <S extends SharedSuggestionProvider> void register(CommandDispatcher<S> dispatcher, P2PNetworkManager networkManager) {
        ...
        dispatcher.register(root
            ...
            .then(LiteralArgumentBuilder.<S>literal("config")
                .executes(context -> {
                    client.schedule(() -> client.setScreen(PlayerRelayClient.config.createScreen(null)));
                    return 1;
                }))
        );
